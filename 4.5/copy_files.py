...
def find_directory(prefix, parent, project):
    ...
    for file in os.listdir(parent):
        if file.startswith(prefix):
            if dir:
                prompt = "You have more than one project " + project + " directory. Please enter the name of your directory (ex. sp24-proj2-githubusername)"
    ...
    if dir == '':
        prompt = "We could not find your project " + project +  " directory. Please enter the name of your directory (ex. sp24-proj2-githubusername)"
        user_input = input(prompt)
        return find_directory(user_input, parent, project)
...
def copy_files():
    ...
    proj2_prefix = 'sp24-proj2-'
    proj3_prefix = 'sp24-proj3-'
